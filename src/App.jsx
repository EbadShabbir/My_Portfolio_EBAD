    ...
    <div className="app">
      ...
      <main id="top">
        <section className="hero">
          <div>
            ...
            <div className="actions">
              ...
              <a className="secondary" href={links.resume} target="_blank" rel="noreferrer">Resume</a>
            </div>
          </div>
        ...
        <section id="about" className="section about">
          ...
          <p>I work on compact AI systems that keep quality high while reducing memory, latency, and compute cost. My current focus is visiting-student research at MBZUAI, with previous research work at IIT Delhi and Macquarie Social NLP Lab.</p>
